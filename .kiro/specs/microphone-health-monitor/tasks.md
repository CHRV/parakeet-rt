...
- [x] 1. Create AudioHealthMonitor module with core monitoring logic
...
- [x] 2. Add command-line arguments for health monitoring configuration
...
- [x] 3. Integrate AudioHealthMonitor into the recording thread
...
- [x] 4. Implement warning and status message formatting
